...
```{r}
theme_ef <- theme_bw() + theme(panel.border = element_rect(colour = "black", fill="NA", size=1),
...
ggplot() + 
  ...
  geom_sf(huc6_sim, mapping=aes(), fill=NA, color="black", lwd=1.25)+
...
## Facet map showing the locations of all the Eflow class locations

```{r facet eflow percents, fig.height=12, fig.width=12, message=FALSE}
