...
huc_data <- sf::st_as_sf(rgdal::readOGR(paste("data/phase2/cluster_species_level_refined.gpkg", sep=""),"nodelta_noempty_species_refined_2018_09_11", stringsAsFactors=FALSE))
