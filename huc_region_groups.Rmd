...
huc_data <- sf::st_as_sf(rgdal::readOGR(paste("data/report_update/clusters.gpkg", sep=""),"june_2018_all_current_trans_3to7", stringsAsFactors=FALSE))
...
In this \version (June 2018) of the clustering, translocations were*included*. All HUCs were included, regardless of the minimum number of taxa (includes ones with one or none). Clustering was done with Flow Sensitive Taxa.
