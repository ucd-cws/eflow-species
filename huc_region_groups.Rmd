...
species_maps <-function(groupname, title, region_data){
      ...
      huc_data_mapping <- huc_data %>% gather(key=model_run, value=grouping, paste(groupname,"_4",suffix, sep=""),paste(groupname,"_5",suffix, sep=""),paste(groupname,"_6",suffix, sep=""),paste(groupname,"_7",suffix, sep=""),paste(groupname,"_8",suffix, sep=""))
