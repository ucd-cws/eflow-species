...
gb_region_name = "greatbasin"
gb_species_info <- species_maps(gb_region_name, "Great Basin")
...
coast_species_info <- species_maps(coast_region_name, "Coast")
...
desert_region_name = "desert"
desert_species_info <- species_maps(desert_region_name, "Desert")
desert_species_info$region_map  # print the map
print_dominance_plots(desert_species_info, desert_region_name)
desert_species_lists <- species_lists_by_group_dfs(desert_species_info$species_data, desert_region_name)  # species_info$species_data is the data frame for the region

for(df in desert_species_lists){
  show(knitr::kable(df, format="html"))
}
