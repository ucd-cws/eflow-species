...
cluster_layer_name <- "clusters_noestuary_species_aggregation_v13_2018_09_17"
source(mapping_code)

```


```{r many_statewide_random_setup}
cluster_geopackage <- file.path("../..", "data/phase2/cluster_species_level_refined.gpkg")
cluster_layer_name <- "nodelta_noempty_species_refined_2018_09_11"
source(mapping_code)

data_statewide_random <- huc_data
